...
class ScannerForm extends FormBase {
   ...
   * {@inheritdoc}
   */
  public function __construct(PrivateTempStoreFactory $tempStore, ScannerPluginManager $scannerManager, LanguageManagerInterface $languageManager, Renderer $render, AccountProxyInterface $currentUser, ConfigFactoryInterface $config_factory) {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['replace'] = [
      ...
      '#maxlength' => 256,
      '#access' => (bool) $this->currentUser->hasPermission('perform search and replace'),
    ];
    $form['submit_replace'] = [
      '#type' => 'submit',

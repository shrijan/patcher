...
/**
 * Provides a field that calculates entity usage count.
 *
 * @ViewsField("entity_usage_count")
 */
class EntityUsageCount extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    // Calculate the usage.
    $usage = $this->entityUsageService->getSourceEntityIds(
      $this->getEntityType(),
      $entity->id()
    );
